...
|             | 08 LangGraph 基础                                                                                         |                                🚧撰写中                                | `State` · `Node` · `Conditional Edge` · RAG+反思      |  ⭐⭐⭐  |
|             | 09 LangGraph 进阶                                                                                         |                                 🚧                                  | `Multi-Agent` · `Human-in-the-Loop` · “总控-员工”架构     | ⭐⭐⭐⭐  |
...
|             | 14 综合实战项目                                                                                               |                                 🚧                                  | "后端双模" (LangGraph+Swarm) + RAG + MCP + Vercel       | ⭐⭐⭐⭐⭐ |
